...
window.__require?(window.require=window.__require,window.requirejs=window.__requirejs,window.define=window.__define):delete window.define.amd;(function(){try{delete window.__require}catch(a){window.__require=void 0}try{delete window.__requirejs}catch(b){window.__requirejs=void 0}try{delete window.__define}catch(c){window.__define=void 0}})();
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:module-exporter', location = '/includes/js/module-exporter.js' */
define("confluence/module-exporter",[],function(){var f={namespace:function(d,e,a){for(var b=d.split("."),a=a||window,c=0,f=b.length-1;c<f;c++)var g=a[b[c]],a=null!=g?g:a[b[c]]={};a[b[c]]&&window.console&&(window.console.warn&&window.__DEBUG__)&&window.console.warn('Value of "'+d+'" was overridden');a[b[c]]=e||a[b[c]]||{};return a[b[c]]},safeRequire:function(d,e){if(define&&void 0===define.amd){var a=require(d);e&&e(a)}},exportModuleAsGlobal:function(d,e,a){f.safeRequire(d,function(b){f.namespace(e,
b);a&&a(b)})}};return f});
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__399d6bb24e6280e2241deb4e98d541ff=function(){var b={};"use strict";Object.defineProperty(b,"__esModule",{value:!0});var a=__4d02fe17b8e885a34493e34af3d145dd,a=a&&a.__esModule?a:{"default":a};(0,a.default)("version","6.0.0");b.default="6.0.0";return b=b["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__906ea2ee8af7ec57662c322a720a678d=function(){function d(a){return a&&a.__esModule?a:{"default":a}}function j(a){this.element=a;this.$element=(0,e.default)(a);this.index=(0,e.default)("aui-header, .aui-header").index(a);this.$secondaryNav=this.$element.find(".aui-header-secondary .aui-nav").first();this.menuItems=[];this.totalWidth=0;this.rightMostNavItemIndex=this.$moreMenu=void 0;this.$applicationLogo=this.$element.find("#logo");this.primaryButtonsWidth=
this.moreMenuWidth=0;var b=(0,e.default)(this.$element[0].querySelector(".aui-header-primary"));this.$headerFind=function(a){return b.find(a)}}var h={};"use strict";Object.defineProperty(h,"__esModule",{value:!0});var e=d(__307d3e18fd611f85395c67cddeb1fe24),o=d(__5a18a90cc502f556e87c4181f8a6b4ab),p=d(__c6e18cf9266fe56d02f78a6e812f58db),q=d(__d74c881c8f23921c15438d0f30c99f80),k=d(__c1ce1f1e3e613f564fc234ff043570f1),l=d(__f52b7059926ab2bdcd0aee12b4bc782b),n=(0,e.default)(window);j.prototype={init:function(){var a=
this;this.element.setAttribute("data-aui-responsive","true");this.$headerFind(".aui-button").parent().each(function(){a.primaryButtonsWidth+=(0,e.default)(this).outerWidth(!0)});this.$headerFind(".aui-nav > li > a:not(.aui-button)").each(function(){var b=(0,e.default)(this).parent(),f=b.outerWidth(!0);a.totalWidth+=f;a.menuItems.push({$element:b,outerWidth:f})});this.rightMostNavItemIndex=this.menuItems.length-1;n.on("resize",this._resizeHandler=(0,p.default)(function(){a.constructResponsiveDropdown()},
100));var b=this.$applicationLogo.find("img");0!==b.length&&(b.attr("data-aui-responsive-header-index",this.index),b.load(function(){a.constructResponsiveDropdown()}));this.constructResponsiveDropdown();this.$headerFind(".aui-nav").css("width","auto")},destroy:function(){n.off("resize",this._resizeHandler)},calculateAvailableWidth:function(){var a=this.$secondaryNav.is(":visible")?this.$secondaryNav.offset().left:this.$element.outerWidth(),b=this.$applicationLogo.offset().left+this.$applicationLogo.outerWidth(!0)+
...
for(var b=-1;0<=a-this.menuItems[b+1].outerWidth;)a-=this.menuItems[b+1].outerWidth,b++;b<this.rightMostNavItemIndex?this.moveToResponsiveDropdown(this.rightMostNavItemIndex-b):this.rightMostNavItemIndex<b&&this.moveOutOfResponsiveDropdown(b-this.rightMostNavItemIndex)}}},createResponsiveDropdownTrigger:function(){var a=document.createElement("li"),b=document.createElement("aui-dropdown-menu");b.id="aui-responsive-header-dropdown-"+this.index;k.default.init(b);var c=document.createElement("aui-section");
c.id="aui-responsive-header-dropdown-list-"+this.index;k.default.init(c);l.default.wrap(b).appendChild(c);c=document.createElement("a");c.setAttribute("class","aui-dropdown2-trigger");c.setAttribute("href","#");c.id=b.id+"-trigger";c.setAttribute("aria-controls",b.id);c.innerHTML=q.default.getText("aui.words.more");a.appendChild(c);a.appendChild(b);0===this.primaryButtonsWidth?this.$headerFind(".aui-nav").append(a):this.$headerFind(".aui-nav > li > .aui-button:first").parent().before(a);this.moreMenuWidth=
(0,e.default)(a).outerWidth(!0);return(0,e.default)(a)},moveOutOfResponsiveDropdown:function(a){if(!(0>=a)){for(var b=(0,e.default)("#aui-responsive-header-dropdown-"+this.index),c=this.rightMostNavItemIndex+a,f=this.rightMostNavItemIndex+1;f<=c;f++){var m=this.menuItems[f].$element,g=m.children("a"),d=(0,e.default)("#"+g.attr("aria-controls"));g.attr("aria-controls")&&(d.removeClass("aui-dropdown2-sub-menu"),m.append(d));b.find("aui-item-link:first").remove();m.insertBefore(this.$moreMenu)}this.rightMostNavItemIndex+=
a}},moveToResponsiveDropdown:function(a){if(!(0>=a)){for(var b=l.default.wrap(this.$moreMenu[0].querySelector("aui-section")),c=this.rightMostNavItemIndex-a+1,f=this.rightMostNavItemIndex;f>=c;f--){var d=this.menuItems[f].$element,g=d.children("a"),h=(0,e.default)("#"+g.attr("aria-controls")),i=document.createElement("aui-item-link");i.setAttribute("href",g.attr("href"));g.attr("aria-controls")&&(i.setAttribute("for",g.attr("aria-controls")),h.addClass("aui-dropdown2-sub-menu"),h.appendTo("body"));
k.default.init(i);l.default.wrap(i).textContent=g.text();d.detach();b.insertBefore(i,b.firstChild);this.element.dispatchEvent(new o.default("aui-responsive-menu-item-created",{bubbles:!0,detail:{originalItem:d[0],newItem:i}}))}this.rightMostNavItemIndex-=a}},showAll:function(){this.moveOutOfResponsiveDropdown(this.menuItems.length-1-this.rightMostNavItemIndex);this.hideResponsiveDropdown()}};h.default=function(a){var b=a._header;b instanceof j||(b=new j(a),b.init(),a._header=b);return b};return h=
h["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__5e80b2d38fa1ffdd67aa3d521738d499=function(){function b(){if(null===b){var a=(0,e.default)('<div style="height: 10px; height: -webkit-calc(20px + 0); height: calc(20px);"></div>');c.supportsCalc=b=20===a.appendTo(document.documentElement).height();a.remove()}return b}var d={},c=d;"use strict";Object.defineProperty(c,"__esModule",{value:!0});c.supportsCalc=b;c.supportsRequestAnimationFrame=function(){return!!window.requestAnimationFrame};c.supportsVoiceOver=
function(){return f};var a=__307d3e18fd611f85395c67cddeb1fe24,e=a&&a.__esModule?a:{"default":a},b=null,f=/Mac OS X/.test(navigator.userAgent);return d}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
null)}};return g}var m={};"use strict";Object.defineProperty(m,"__esModule",{value:!0});m.popup=m.Dialog=void 0;var y="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a},h=r(__307d3e18fd611f85395c67cddeb1fe24),B=t(__cf890abdf040e0993fb71f2f839bc972),v=t(__c8cfa00f1eba9ac7af89ee3d0d33961d),s=__bf6c7c62de0eb613e0ab12d56d9a6197,u=__594942bfcf520d6e5a0843b1cfdd039a,A=__05b42b82bab2942063ea875333a900bb,
j=r(__fd277fcde858b82a198666a405e85600),w=r(__4d02fe17b8e885a34493e34af3d145dd),n,o=function(a,b,c,d){a.buttonpanel||a.addButtonPanel();this.page=a;this.onclick=c;this._onclick=function(b){return!0===c.call(this,a.dialog,a,b)};this.item=(0,j.default)("button",b).addClass("button-panel-button");d&&this.item.addClass(d);"function"==typeof c&&this.item.click(this._onclick);a.buttonpanel.append(this.item);this.id=a.button.length;a.button[this.id]=this},C=function(a,b,c,d,e){a.buttonpanel||a.addButtonPanel();
...
if(a){var c=b.attr("title");b.attr("title",c.replace(a,""));b.removeData("kbShortcutAppended")}},keypressHandler:q,defaultPreventionHandler:d})}var r={};"use strict";Object.defineProperty(r,"__esModule",{value:!0});var e=p(__307d3e18fd611f85395c67cddeb1fe24);__9d8814c2d651791325671e2fd4ff2ade;__55cc9a6466186ba6dac3b7d90666eefa;var s;var f=__cf890abdf040e0993fb71f2f839bc972;if(f&&f.__esModule)s=f;else{var t={};if(null!=f)for(var o in f)Object.prototype.hasOwnProperty.call(f,o)&&(t[o]=f[o]);t.default=
f;s=t}var v=__8eca5e5171c0c22be18ea931ed65c747;o=p(__4d02fe17b8e885a34493e34af3d145dd);p(__d74c881c8f23921c15438d0f30c99f80);var x=p(__509557c937caa8763def39004fcf3193),u=-1!==navigator.platform.indexOf("Mac"),w=/^(backspace|tab|r(ight|eturn)|s(hift|pace|croll)|c(trl|apslock)|alt|pa(use|ge(up|down))|e(sc|nd)|home|left|up|d(el|own)|insert|f\d\d?|numlock|meta)/i;j.makeShortcut=function(g){function f(c){return function(a,b){var b=b||{},k=b.focusedClass||"focused",f=b.hasOwnProperty("wrapAround")?b.wrapAround:
...
WRM.define("wrm/require-handler",["wrm/jquery","wrm/_","wrm/builder","wrm/conditional-comment-filter","wrm/ie-only-filter"],function(d,h,i,g,a){var e=/^wr!(.*)$/,c=/^wrc!(.*)$/,f=/^.+!/;var b=function(){this._requireCache={};this._requestedResources={contexts:[],webResources:[]};this._requestInFlight=false;this._requestWaiting=false};b.prototype={require:function(n,j){if(!h.isArray(n)){n=[n]}if(!this._requireCache.hasOwnProperty(n)){var k=d.Deferred();function l(){this._resolveAsync(n).then(k.resolve,k.reject)}var m=window.WRM&&window.WRM.InOrderLoader;if(m!==undefined){m.registerAllResolvedCallback(l.bind(this))}else{l.call(this)}this._requireCache[n]=k.promise()}var o=this._requireCache[n];if(j){o.done(function(){j.apply(this,arguments)})}return o},_resolveAsync:function(l){this._addToRequestedResources(l);var j=d.Deferred();var k=this;if(this._requestInFlight===false){this._requestInFlight=this._getScriptsForResources().done(this._processResourceResponse.bind(this,j,l))}else{if(this._requestWaiting===false){this._requestWaiting=j;this._requestInFlight.done(function(){k._requestInFlight=k._getScriptsForResources().done(k._processResourceResponse.bind(k,j,l));k._requestWaiting=false})}else{return this._requestWaiting.promise()}}return j.promise()},_processResourceResponse:function(s,k,n){this._requestInFlight=false;var q=this;if(n.unparsedData){window.WRM._unparsedData||(window.WRM._unparsedData={});h.each(n.unparsedData,function(u,t){window.WRM._unparsedData[t]=u});window.WRM._dataArrived()}if(n.unparsedErrors){window.WRM._unparsedErrors||(window.WRM._unparsedErrors={});h.each(n.unparsedErrors,function(u,t){window.WRM._unparsedErrors[t]=u});window.WRM._dataArrived()}var l=[];var o=[];var r=this._filter(n.resources);for(var p=0;p<r.length;++p){var m=r[p];var j=m.url;if(!this._isDarkFeatureEnabled("wrm.disable.duplicate.resource.download.fix")){this._builder.addResource(m.key,m.batchType,this._loadedResources)}if(m.resourceType==="JAVASCRIPT"){if(!this._isJSInInitLoad(j)){l.push("js!"+j+"!order")}}else{if(m.resourceType==="CSS"){if(!this._isCSSInInitLoad(j)){if(m.media&&"all"!==m.media){o.push(m)}else{l.push("css!"+j)}}}else{AJS.log("Unknown resource type required: "+j)}}}AJS.log("Downloading resources:\n"+l.join("\n"));WRM.curl(l,function(){h.each(o,function(u){q._loadCssImmediate(u)});var t=h.map(k,function(){return window});s.resolveWith(q,t)},function(){s.rejectWith(q,arguments)})},_loadCssImmediate:function(k){AJS.log("WARN: asynchronously loading a CSS resource containing a media query: "+k.url);var j='<link rel="stylesheet" type="text/css" href="'+k.url+'" media="'+k.media+'" />';d(j).appendTo("head")},_getScriptsForResources:function(){if(!this._builder){this._builder=new i();this._loadedResources=this._builder.initialize(document)}else{this._updateLoadedResourcesFromDom()}var j=d.ajax({url:AJS.contextPath()+"/rest/webResources/1.0/resources",type:"POST",contentType:"application/json",dataType:"json",data:JSON.stringify({r:this._requestedResources.webResources,c:this._requestedResources.contexts,xc:this._loadedResources.contexts,xr:this._loadedResources.modules})});this._requestedResources.webResources=[];this._requestedResources.contexts=[];return j},_updateLoadedResourcesFromDom:function(){function k(l,m){h.each(l,function(n){if(m.indexOf(n)===-1){m.push(n)}})}var j=this._builder.initialize(document);k(j.modules,this._loadedResources.modules);k(j.contexts,this._loadedResources.contexts)},_addToRequestedResources:function(k){var j=this;h.each(k,function(m){var l;if(l=m.match(e)){j._requestedResources.webResources.push(l[1])}else{if(l=m.match(c)){j._requestedResources.contexts.push(l[1])}else{j._requestedResources.webResources.push(m.replace(f,""))}}})},_isJSInInitLoad:function(j){return d("script[src='"+j+"']").length>0},_isCSSInInitLoad:function(j){return d("link[href='"+j+"']").length>0},_filter:function(k){if(!this._filters){this._filters=[g,a]}var j=k;h.each(this._filters,function(l){j=l(j)});return j},_isDarkFeatureEnabled:function(j){if(h.isUndefined(AJS)||h.isUndefined(AJS.DarkFeatures)||h.isUndefined(AJS.DarkFeatures.isEnabled)){return false}return AJS.DarkFeatures.isEnabled(j)}};return b});
}catch(e){WRMCB(e)};
;
try {
...
define("confluence/root",["ajs","jquery","window"],function(b,g,h){var e={getContextPath:function(){return b.Meta.get("context-path")},getBaseUrl:function(){return g("#confluence-base-url").attr("content")||""},getBuildNumber:function(){return b.Meta.get("build-number")},getContentId:function(){var a=b.Meta.get("content-id");+a||(a=b.Meta.get("page-id"));+a||(a="0");return a},getXsrfToken:function(){return b.Meta.get("atl-token")},runBinderComponents:function(){for(var a in e.Binder)if(e.Binder.hasOwnProperty(a))try{e.Binder[a]()}catch(c){b.logError("Exception in initialising of component '"+
a+"': "+c.message)}},placeFocus:function(){e.Binder.placeFocus()},unescapeEntities:function(a){var c={amp:"&",lt:"<",gt:">","#39":"'",quot:'"'};return null==a?a:(""+a).replace(/&[#\d\w]+;/g,function(a){var b=a.substring(1,a.length-1);return c[b]||a})},sessionCheck:function(a,c){var d=b.Meta.get("remote-user");if(d){var f=this.getContextPath()+b.REST.getBaseUrl()+"session/check/"+d,e=this;return g.getJSON(f).done(function(){b.debug("SESSION CHECK - OK - "+d)}).fail(function(){b.log("SESSION CHECK - FAIL - "+
d);e.sessionFail(a,c)})}},sessionFail:function(a,c){if(!a){var d=g(".aui-dialog:visible");if(d.length)a=d.find(".dialog-panel-body").empty(),d.find(".aui-button").attr("disabled","disabled");else throw Error("sessionFail method really expected a visible dialog about now :/");}c||(c=b.format("Your session has expired. Please {0}reload{1} the page to try again.",'<a class="reload" href="">',"</a>"),a.on("click","a.reload",function(){h.location.reload()}));b.messages.warning(a,{body:c,closeable:!1,shadowed:!0})},Binder:{placeFocus:function(){var a,
c=-1;g("input[data-focus]").each(function(){var b=g(this),f=b.attr("data-focus");f>c&&(c=f,a=b)});a&&a.focus()}},hintManager:function(a){if(!g.isArray(a))throw Error("Hints passed in must be an array of strings");var b=Math.floor(Math.random()*a.length);return{getNextHint:function(){var d=a[b];b=(b+1)%a.length;return d}}}},i=!1,k="",j={},l={},f=h.performance,m=function(){if(i){for(var a={},c={name:k,data:a},d=f.getEntriesByType("measure"),e=0;e<d.length;e++){var g=d[e],h=g.name;j[h]&&(a[h+".startTime"]=
g.startTime,a[h+".duration"]=g.duration)}b.trigger("analyticsEvent",c);i=!1}},n=!1;e.registerPerformanceSession=function(a,c,d){n?b.warn("A session is already active, registering a new session will override the previous session"):(n=!0,k=a,j=c,l=d,h.addEventListener("beforeunload",function(){i&&m()}))};e.debugTime=function(a){f&&(f.mark&&j[a])&&(i||(i=!0),f.mark(a+".start"));b.debugEnabled()&&console.time&&(console.log(a+" started"),console.time(a))};e.debugTimeEnd=function(a){if(f&&f.mark&&j[a]){var c=
a+".start";if(0===f.getEntriesByName(c,"mark").length)b.warn("Calling debugTimeEnd for "+a+" before debugTime");else{var d=a+".end";f.mark(d);f.measure(a,c,d);l[a]&&m()}}b.debugEnabled()&&console.timeEnd&&console.timeEnd(a)};return e});require("confluence/module-exporter").exportModuleAsGlobal("confluence/root","Confluence",function(b){var g=require("ajs");g.toInit(function(){b.runBinderComponents()});g.Confluence=b});
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/defaults.js' */
define("confluence/defaults",[],function(){return{maxResults:50}});require("confluence/module-exporter").exportModuleAsGlobal("confluence/defaults","Confluence.Defaults");
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/highlighter.js' */
...
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/position.js' */
...
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/object-cache.js' */
...
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/confluence-storage-manager.js' */
define("confluence/confluence-storage-manager",["ajs"],function(a){return function(b){return a.storageManager("confluence",b)}});require("confluence/module-exporter").exportModuleAsGlobal("confluence/confluence-storage-manager","Confluence.storageManager");
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:core', location = '/includes/js/input-driven-dropdown.js' */
...
define("confluence/search-results-grid",["jquery","ajs","confluence/templates"],function(f,d,g){return function(b,c,i,a){var e=c.results;if(!e||!e.length)c=d.format(a.noSearchResults,d.escapeEntities(b)),this.html("<div class='no-results'>"+c+"</div>");else{this.html(g.SearchResultsGrid.searchResultsGrid());c.skipResultCount||(b=d.format(a.resultsCount,c.startIndex+1,c.startIndex+e.length,c.total,d.escapeEntities(b)),this.prepend(g.SearchResultsGrid.searchResultsGridCount({count:d.html(b)})));for(b=
0;b<e.length;b++){var a=e[b],a=c.convertFromRest?{id:a.id,title:a.title,url:d.REST.findLink(a.link),type:a.type,spaceName:a.space?a.space.title:"",spaceKey:a.space?a.space.key:"",friendlyDate:a.lastModifiedDate?a.lastModifiedDate.friendly:"",date:a.lastModifiedDate?a.lastModifiedDate.date:""}:a,h=f(g.SearchResultsGrid.searchResultsGridRow({title:a.title,href:a.url,contentType:a.type,spaceName:a.spaceName,spaceHref:d.contextPath()+"/spaces/"+a.spaceKey,date:a.friendlyDate,dateTitle:a.date}));"attachment"==
a.type&&a.id&&h.attr("data-attachment-id",a.id);h.selectableEffects(this,i.select,e[b]);this.find("table").append(h)}f(".search-result:first",this).click()}}});require("confluence/module-exporter").safeRequire("confluence/search-results-grid",function(f){require("jquery").fn.searchResultsGrid=f});
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:search-results-grid', location = '/includes/soy/search-results-grid.soy' */
// This file was automatically generated from search-results-grid.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace Confluence.Templates.SearchResultsGrid.
 */

if (typeof Confluence == 'undefined') { var Confluence = {}; }
if (typeof Confluence.Templates == 'undefined') { Confluence.Templates = {}; }
if (typeof Confluence.Templates.SearchResultsGrid == 'undefined') { Confluence.Templates.SearchResultsGrid = {}; }


Confluence.Templates.SearchResultsGrid.searchResultsGrid = function(opt_data, opt_ignored) {
  return '<table class="aui"><thead><tr class="header"><th class="search-result-title">' + soy.$$escapeHtml("Page Title") + '</th><th class="search-result-space">' + soy.$$escapeHtml("Space") + '</th><th class="search-result-date">' + soy.$$escapeHtml("Updated") + '</th></tr></thead></table>';
};
if (goog.DEBUG) {
  Confluence.Templates.SearchResultsGrid.searchResultsGrid.soyTemplateName = 'Confluence.Templates.SearchResultsGrid.searchResultsGrid';
}


Confluence.Templates.SearchResultsGrid.searchResultsGridCount = function(opt_data, opt_ignored) {
  return '<p class="search-result-count">' + soy.$$filterNoAutoescape(opt_data.countContent) + '</p>';
};
if (goog.DEBUG) {
  Confluence.Templates.SearchResultsGrid.searchResultsGridCount.soyTemplateName = 'Confluence.Templates.SearchResultsGrid.searchResultsGridCount';
}


Confluence.Templates.SearchResultsGrid.searchResultsGridRow = function(opt_data, opt_ignored) {
  return '<tr class="search-result"><td class="search-result-title"><a href="' + soy.$$escapeHtml(opt_data.href) + '" class="content-type-' + soy.$$escapeHtml(opt_data.contentType) + '"><span>' + soy.$$escapeHtml(opt_data.title) + '</span></a></td><td class="search-result-space"><a class="space" href="' + soy.$$escapeHtml(opt_data.spaceHref) + '" title="' + soy.$$escapeHtml(opt_data.spaceName) + '">' + soy.$$escapeHtml(opt_data.spaceName) + '</a></td><td class="search-result-date"><span class="date" title="' + soy.$$escapeHtml(opt_data.dateTitle) + '">' + soy.$$escapeHtml(opt_data.date) + '</span></td></tr>';
};
if (goog.DEBUG) {
  Confluence.Templates.SearchResultsGrid.searchResultsGridRow.soyTemplateName = 'Confluence.Templates.SearchResultsGrid.searchResultsGridRow';
}
...
;
try {
/* module-key = 'confluence.web.resources:jquery-amd', location = '/includes/js/amd/shim/jquery-amd.js' */
define("jquery",function(){return"undefined"!==typeof jQuery?jQuery:Zepto});
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'confluence.web.resources:viewpage-webitems', location = '/includes/js/save-for-later.js' */
define("confluence/save-for-later",["ajs","jquery","confluence/api/ajax","skate"],function(a,d,j,f){var i=function(b){0<(d("#action-messages").html()||"").indexOf(b)||a.messages.error("#action-messages",{body:b})},g=function(b){var c=d(b),f=c.find(".aui-icon"),g="Remove",h="Save for later",k="f",l=a.format("Saved {0}f{1}or later","<u>","</u>"),m=a.format("Save {0}f{1}or later","<u>",
"</u>"),n="You are not permitted to perform this operation.",o="Server error while updating favourite";c.on("click",function(b){var e=c.hasClass("selected");if(c.hasClass("waiting"))return a.stopEvent(b);c.addClass("waiting");var d=a.contextPath()+"/rest/experimental/relation/user/current/favourite/toContent/"+(c.attr("data-page-id")||a.params.pageId);j.ajax({url:d,type:e?"DELETE":"PUT",contentType:"application/json",data:{},success:function(){c.toggleClass("selected ie-page-favourite-selected",
!e);var b=!e?g:h,b=b+(" ("+k+")"),d=!e?l:m;c.children("span").empty().append(f).append(" "+d);c.attr("title",b);f.toggleClass("aui-iconfont-unstar",e).toggleClass("aui-iconfont-star",!e);a.trigger("analytics",{name:"confluence.page.page-menu."+(e?"unfavourite":"favourite")})},error:function(a){403===a.status?i(n):i(o)},complete:function(){c.removeClass("waiting");c.blur()}});return a.stopEvent(b)})},h=function(a){d(a).off("click")};return{attached:g,detached:h,init:function(){f("action-page-favourite",
...
define("confluence/menu",["ajs","jquery","document","window"],function(d,a,e,j){var i={};d.menuShowCount=0;var k=function(c){a(c).closest(".ajs-menu-bar").find(".ajs-drop-down").each(function(){this.hide()})},m=function(c){return a(c).closest(".ajs-menu-bar").hasClass("menu-bar-open")},n=function(c){a(c).closest(".ajs-menu-bar").addClass("menu-bar-open")},o=function(c){a(c).closest(".ajs-menu-bar").removeClass("menu-bar-open")};i.ajsMenu=function(c){c=c||{};a(".ajs-button",this).each(function(){a(this).mouseover(function(){var c=
this,d=m(c);k(c);if(d){var b=a(e),f=function(){o(c);return!1};b.unbind("click.menu");setTimeout(function(){b.one("click.menu",f)},1);n(c)}})});a(".ajs-menu-item",this).each(function(){a(this).ajsMenuItem(c)})};i.ajsMenuItem=function(c){var c=c||{},d=this,g=a(this),b=a(".ajs-drop-down",d);if(b.length){b=b[0];b.hidden=!0;b.focused=-1;b.hide=function(){if(!this.hidden){g.toggleClass("opened");0===a(d.parentNode).find(".opened").length&&o(d);var c=a("a",this);a(this).toggleClass("assistive");this.hidden=
!0;a(e).unbind("click",this.fhide).unbind("keydown",this.fmovefocus).unbind("keypress",this.blocker);this.focused+1&&a(c[this.focused]).removeClass("active");this.focused=-1}};b.show=function(){if("undefined"===typeof this.hidden||this.hidden){var b=this,h=a(this);h.toggleClass("assistive");g.toggleClass("opened");n(d);this.hidden=!1;this.timer=setTimeout(function(){a(e).click(b.fhide)},1);a(e).keydown(b.fmovefocus).keypress(b.blocker);var l=a("a",b);l.each(function(c){var b=this.parentNode.parentNode;
a(this).hover(function(){b.focused+1&&a(l[b.focused].parentNode).removeClass("active");a(this.parentNode).addClass("active");b.focused=c},function(){b.focused+1&&a(l[b.focused].parentNode).removeClass("active");b.focused=-1})});var p=j.pageYOffset||e.documentElement.scrollTop,f=p+a(j).height();h.removeClass("above");!c.isFixedPosition&&h.offset().top+h.height()>f&&(h.addClass("above"),h.offset().top<p&&h.removeClass("above"))}};b.isMenuBarOpened=function(){return m(b)};b.closeOthers=function(){k(b)};
b.fmovefocus=function(a){b.movefocus(a)};b.fhide=function(c){b.hide(c);return 0<a(c.target).closest(".ajs-drop-down").length};b.blocker=function(a){a=a.which;if(40===a||38===a)return!1};b.movefocus=function(b){var c=b.which,d=this.getElementsByTagName("a"),g=this.focused,e=9===c,f;do{switch(c){case 40:case 9:b.shiftKey?this.focused--:this.focused++;break;case 38:this.focused--;break;case 27:return this.hide(),!1;default:return!0}f=0>this.focused||this.focused>d.length-1}while(!f&&a(d[this.focused].parentNode).hasClass("assistive"));
if(e&&f)return-1!=g&&a(d[g].parentNode).removeClass("active"),this.focused=-1,this.hide(),!1;e||(0>this.focused?this.focused=d.length-1:this.focused>d.length-1&&(this.focused=0));0<=g&&a(d[g].parentNode).removeClass("active");d[this.focused].focus();a(d[this.focused].parentNode).addClass("active");b.stopPropagation();b.preventDefault();return!1};var f=a(".trigger",d);f.length&&(g.mouseover(function(){b.isMenuBarOpened()?b.hidden&&(k(b),b.show()):g.addClass("hover")}),g.mouseout(function(){b.isMenuBarOpened()||
g.removeClass("hover")}),f.click(function(){if(b.hidden){f.parent("li").removeClass("hover");var c=0<a(".ajs-menu-bar.menu-bar-open").length;b.show();return c}b.hide();f.parent("li").addClass("hover");return!1}))}};i.initialiser=function(a){a("#view-user-history-link").click(function(a){j.open(this.href,(this.id+"-popupwindow").replace(/-/g,"_"),"width=600, height=400, scrollbars, resizable");a.preventDefault();return!1});var e=a("#action-menu-link");e.length&&e.next().addClass("most-right-menu-item");
a("#action-menu").on({"aui-dropdown2-show":function(){a(this).css({right:function(){return a(j).width()-e.offset().left-e.outerWidth(!0)-1},left:"auto"})}}).on({click:function(a){d.trigger("analyticsEvent",{name:"page-view-ellipsis-menu",data:{listItemClicked:a.target.id,pageId:d.Meta.get("page-id")}})}});a(".ajs-menu-bar").ajsMenu({isFixedPosition:!0})};i.ieHack=function(){a("#header-menu-bar .ajs-menu-item").each(function(){var c=a(this),e=a(".ajs-drop-down",this),c=c.width();c>e.width()&&(e.width(c.valueOf()+
...
("undefined"===typeof window?global:window).__306e5d088ae3093bce3a4ccc028d1000=function(){function f(a){return a&&a.__esModule?a:{"default":a}}var g={};"use strict";Object.defineProperty(g,"__esModule",{value:!0});var j="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a},c=f(__307d3e18fd611f85395c67cddeb1fe24);__c972538512dcf935ab0c75d63e2e3cff;var k=f(__e3ce9f42f29f6bd2118d84461512f4a4),
...
("undefined"===typeof window?global:window).__928a2470c59a6ae17c3b26224648a948=function(){function f(a){return a&&a.__esModule?a:{"default":a}}var i={};"use strict";Object.defineProperty(i,"__esModule",{value:!0});var l="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol?"symbol":typeof a},g=f(__307d3e18fd611f85395c67cddeb1fe24),m=__1a99a68c34e660050a094f87fb28903d,j=f(__922acd0053a6de3ea4c53d8902766ab6),
h=f(__e3ce9f42f29f6bd2118d84461512f4a4),n=f(__f9e062e0834111cb42fed4e788d40075),k=h.default.Model.extend({sync:function(a,b,d){var e=this,c=d.error;d.error=function(a){e._serverErrorHandler(a,this);c&&c.apply(this,arguments)};return h.default.sync.apply(h.default,arguments)},save:function(a,b){var b=b||{},d=this,e,c=b.error,f=b.success;b.error=function(a,b){var e=g.default.parseJSON(b.responseText||b.data);c&&c.call(d,d,e,b)};this.isNew()?h.default.Model.prototype.save.call(this,a,b):a&&(e=k.extend({url:this.url()}),
