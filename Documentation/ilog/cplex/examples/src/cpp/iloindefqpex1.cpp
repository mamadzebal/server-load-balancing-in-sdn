...
static void
   solveanddisplay   (IloEnv env, IloCplex cplex, IloNumVarArray var, IloRangeArray con);
...
main (int argc, char **argv)
{
   ...
   try {
      ...
      // solutions
      cplex.setParam(IloCplex::Param::SolutionTarget, IloCplex::SolutionFirstOrder);
