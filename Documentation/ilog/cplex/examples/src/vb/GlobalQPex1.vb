   ...
   Public Overloads Shared Sub Main(ByVal args() As String)
      ...
      Try
         ...
         Select Case args(1).ToCharArray()(0)
            Case "c"c
               cplex.SetParam(Cplex.Param.SolutionTarget, cplex.SolutionTarget.OptimalConvex)
            Case "f"c
               cplex.SetParam(Cplex.Param.SolutionTarget, cplex.SolutionTarget.FirstOrder)
            Case "g"c
               cplex.SetParam(Cplex.Param.SolutionTarget, cplex.SolutionTarget.OptimalGlobal)
            Case Else
               Usage()
               Return
         End Select
