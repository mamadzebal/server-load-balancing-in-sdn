   ...
   Public Overloads Shared Sub Main(ByVal args() As String)
      ...
      Try
         ...
         Select Case args(1).ToCharArray()(0)
            Case "o"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Auto)
            Case "p"c
            ...
            Case "h"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Barrier)
            Case "b"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Barrier)
               cplex.SetParam(Cplex.Param.Barrier.Crossover, cplex.Algorithm.None)
            Case "n"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Network)
            Case "s"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Sifting)
            Case "c"c
               cplex.SetParam(Cplex.Param.RootAlgorithm, cplex.Algorithm.Concurrent)
            Case Else
               Usage()
               Return
         End Select
