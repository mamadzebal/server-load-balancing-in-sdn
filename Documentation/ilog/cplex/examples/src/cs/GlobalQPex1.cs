...
public class GlobalQPex1 {
   internal static void Usage() {
      System.Console.WriteLine("usage:  GlobalQPex1 <filename> <solution target>");
   ...
   public static void Main(string[] args) {
      ...
      try {
         ...
         case 'c': cplex.SetParam(Cplex.Param.SolutionTarget,
                                  Cplex.SolutionTarget.OptimalConvex);
                   break;
         case 'f': cplex.SetParam(Cplex.Param.SolutionTarget,
                                  Cplex.SolutionTarget.FirstOrder);
                   break;
         case 'g': cplex.SetParam(Cplex.Param.SolutionTarget,
                                  Cplex.SolutionTarget.OptimalGlobal);
                   break;
         default:  Usage();
                   return;
         }
