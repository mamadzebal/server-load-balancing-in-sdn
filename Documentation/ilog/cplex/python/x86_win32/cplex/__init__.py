...
class Cplex(object):
    ...
    def copy_vmconfig(self, xmlstring):
        ...
        it not touched.
        """
        _internal._procedural.copyvmconfig(self._env._e, xmlstring)
    ...
    def solve(self):
        ...
        if self._is_MIP():
            if _internal._procedural.hasvmconfig(self._env._e):
                _internal._procedural.distmipopt(self._env._e, self._lp)
            else:
