...
class Environment(object):
    ...
    def _needs_delete_callback(self, callback_instance):
        ...
        # delete callback.
        if isinstance(callback_instance, cplex.callbacks.ControlCallback):
            return True
        elif isinstance(callback_instance, cplex.callbacks.BranchCallback):
            return True
        elif isinstance(callback_instance, cplex.callbacks.NodeCallback):
            return True
        elif isinstance(callback_instance, cplex.callbacks.IncumbentCallback):
            return True
        elif hasattr(callback_instance, "set_node_data"):
            return True
        else:
            return False
